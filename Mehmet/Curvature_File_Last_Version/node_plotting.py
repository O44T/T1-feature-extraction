# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 15:05:03 2020
...
def plot_nodes(mypath, filename,b,data,unique, parameters = None):
    dpi = 30
                                ...
                                if (data[i-1,12]< data[i-1,2] and data[i-1,14]< data[i-1,12]
                                   or data[i-1,2]< data[i-1,12] and data[i-1,12]< data[i-1,14]):
                                    ...
                                    def Polynomial_Regression1():
                                        ...
                                        plt.plot(X1,pol_reg.predict(X_poly) , Linewidth = 3,color = 'Red')
                                    ...
                                    def Polynomial_Regression2():
                                        ...
                                        plt.plot(X2,pol_reg.predict(X_poly) , Linewidth = 3,color = 'Red')
                                    ...
                                    def Polynomial_Regression3():
                                        ...
                                        plt.plot(X3,pol_reg.predict(X_poly) , Linewidth = 3,color = 'Red')          
                                    ...
                                    def Polynomial_Regression1():
                                        ...
                                        plt.plot(X5,pol_reg.predict(X_poly) , Linewidth = 4,color = 'Red')
                                    Polynomial_Regression1()        
                                    def Polynomial_Regression2():
                                        poly_reg = PolynomialFeatures(degree=7)
                                        ...
                                        plt.plot(X6,pol_reg.predict(X_poly) , Linewidth = 4,color = 'Red')
                                    Polynomial_Regression2()    
                                    def Polynomial_Regression3():
                                        poly_reg = PolynomialFeatures(degree=7)
                                        ...
                                        plt.plot(X7,pol_reg.predict(X_poly) , Linewidth = 4,color = 'Red')                               
                                    Polynomial_Regression3()
