...
def main():
    ...
    if datafile == "dataset_04.txt":
        ...
        df1 = pd.read_csv('test_start_end_points.txt', sep="   ", header=None, error_bad_lines=False)
        ...
        df1 = df1.dropna()
        df2 = df2.dropna()
        df1.columns = ['frame_number', 'T1_x', 'T1_y','angle1','angle2','angle3','angle4','cu1','cu2','cu3','cu4','chL1','chL2','chL3','chL4','d_tot','theta1','theta2','theta3','theta4','AL1','AL2','AL3','AL4','A1','A2','A3','A4','d11','d21','d31','d41','A1_tot','A2_tot','A3_tot','A4_tot','h1','h2','h3','h4','orientation','label']
        ...
        df['mid3'] = df2['angle3']
        df['mid4'] = df2['angle4']
        df = df.drop(['cu1','cu2','cu3','cu4','d_tot','theta1','theta2','theta3','theta3','A1_tot','A2_tot','A3_tot','A4_tot','h1','h2','h3','h4','orientation'], axis = 1)
    elif datafile == 'test_start_end_points.txt' or 'test_for_mid_points.txt' :
        df.columns = ['frame_number', 'T1_x', 'T1_y','angle1','angle2','angle3','angle4','cu1','cu2','cu3','cu4','chL1','chL2','chL3','chL4','d_tot','theta1','theta2','theta3','theta4','AL1','AL2','AL3','AL4','A1','A2','A3','A4','d11','d21','d31','d41','A1_tot','A2_tot','A3_tot','A4_tot','h1','h2','h3','h4','orientation','label']
    ...
    while i < 2:
        ...
        if i != 0:
            ...
            if do_pca == "Yes":
                ...
                print(pd.DataFrame(pca.components_.transpose(),index=['angle1','angle2','angle3','angle4','cu1','cu2','cu3','cu4','chL1','chL2','chL3','chL4','d_tot','theta1','theta2','theta3','theta4','AL1','AL2','AL3','AL4','A1','A2','A3','A4','d11','d21','d31','d41','A1_tot','A2_tot','A3_tot','A4_tot','h1','h2','h3','h4','orientation','mid1','mid2','mid3','mid4'],columns = ['PC-1','PC-2']))
